												...
												<CardBody className='px-4'>
													<div className='row'>
														<div className='col-sm-12'>
															<h5 className='text-left ft'>Transformation Services </h5>
															<p className='py-1 py-md-3'>
																Synectiks Transformation services elevate your business
																by optimizing every aspect of your operations for the
																public cloud or Hybrid cloud – your people,
															...
															<div className='py-1'>
																<div className='border-bottom my-n1 my-md-n0 text-center'>
																	...
																	<p className='ptext  f-14 px-1 px-md-4 text-left'>
																		Ensure every bit of your hardware environment is
																		directly supporting your business objectives.
																		The transition from a hardware-centric to a
																		software-defined organization makes a huge
																		difference in CapEx and OpEx.
																	</p>
																</div>
															</div>
														</div>
														<div className='col-sm-12  p-1'>
															<div className='py-1'>
																<div className='border-bottom my-n1 my-md-n0 text-center'>
																	...
																	<p className='ptext  f-14 px-1 px-md-4 text-left'>
																		Applications that power your enterprise are key
																		to generating a strong competitive advantage.
																		Bring innovation, agility and outstanding
																		customer experience through modern architectures
														...
														<div className='col-sm-12  p-1'>
															<div className='py-1'>
																<div className='border-bottom my-n1 my-md-n0 text-center'>
																	...
																	<p className='ptext  f-14 px-1 px-md-4 text-left'>
																		Adopting a DevOps culture starts by transforming
																		your people, technology and processes.
																		Accelerate your DevOps adaption by using our
																		open Automation platform and skilled resources.
																	</p>
																</div>
															</div>
														</div>
												...
												<CardBody>
													...
													<div className='px-4'>
														...
														<p>
															...
															Xformation helps you to migrate and modernize your legacy
															business, take advantage of cloud and microservice
															architecture and thereby accelerate your transformation
															journey @50% time & cost.  <br />{' '}
														...
														<div className='py-1 py-md-3 h-100'>
															<div className='border-right text-center'>
																...
																<p className='f-14 px-4 text-left'>
																	...
																	Synectiks-Business Continuity solutions. Synectiks
																	-Protect Cloud changes the game by integrating Data
																	protection with high security. This synergy
																	eliminates the complexity and makes security a
																	center point of your solutions, keeping your
														...
														<div className='py-3 h-100'>
															<div className='border-right text-center'>
																...
																<p className='f-14 px-4 text-left'>
																	...
																	wide variety of workloads & Disaster Recovery with a
																	high degree of control, security, and simplicity.
																	Supports your mission-critical applications and
																	workloads with instant and scalable infrastructure
																	meeting business compliance standards.
																</p>
															</div>
														</div>
													</Col>
														...
														<div className='py-1 py-md-3 h-100'>
															<div className='border-right text-center'>
																...
																<p className='f-14 px-4 text-left'>
																	...
																	operating costs, and mitigate security and
																	compliance risks in a cost-effective monthly
																	consumption model. As AWS Consulting Services
																	Partner, our experts ensure that your workloads meet
																	the requirements of the AWS Well-Architected
																	Framework for efficient migration and operation in
																	the AWS secured landing zones.
																	<br />
																</p>
															</div>
														</div>
