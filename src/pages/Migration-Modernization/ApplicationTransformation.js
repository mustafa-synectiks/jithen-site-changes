										...
										<TabPane tabId='1'>
											<div>
												...
												<p className='ptext'>
													...
													software business – driving innovation, agility and outstanding
													customer experience from within.
												</p>
												<p className='ptext'>
												...
												<p className='ptext'>
													Our application transformation services close the gap between what
													your current applications can do and what the cloud-native services
													and microservices architecture make them capable of. That could be
													greater efficiency, scale, performance and resilience. But it could
													also mean entirely new capabilities that create lasting advantage,
													generate value and drive better outcomes for your customers and your
													employees.
												</p>
												<p className='ptext'>
												...
												<ul className='ptext'>
													...
													<li>
														...
														cloud in private address space ensuring security and
														performance.
													</li>
													<li>By having built-in security from the start.</li>
												</ul>
												<p className='ptext'>
													Synectiks open product driven solutions delivery approach coupled
													with many large scale application transformation experience delivers
													the speed, innovations, quality and better economics that your
														...
														<div>
															<div>
																...
																<p className=''>
																	...
																	and set common goals. Within the IT organization,
																	CIOs must set policies that identify the need to
																	prepare for Application modernization as a priority
																	for overall IT strategies and create a clearly
																	defined journey with confidence. Synectiks
															...
															<div className='confidence row my-md-5'>
																<div className='leftcol col-md-4'>
																	<div className='leftcolOne'>
																		...
																		<p className='text-left'>
																			...
																			existing applications for greater efficiency
																			and economics, risks involved, and ROI
																...
																<div className='rightcol col-md-4 '>
																	...
																	<div className='rightcolTwo'>
																		...
																		<p className=''>
																			Elevate people skills, operation automation
																			and service agility to support modernized
																			applications.
																		</p>
																	</div>
																</div>
															...
															<div className='bottomCol'>
																...
																<p className=''>
																	The teams perform a quick requirements analysis and
																	GAP analysis to understand the current setup and
																	provide solutions to optimize your applications,
																	storage, databases and overall infrastructure. The
																	very first step, discovery and assessment will give
																	you clear insights on the improved SLA’s and cost
																	savings. You can make informed decisions to balance
																	workloads and optimize resources and thereby, to
																	create a roadmap that guides the journey to
																	Application modernization. This roadmap should map
																	people, process, technology change requirement,
																	consider IT policy and operating model factors; and
																	ultimately produce clear, data-based recommendations
																	with a proposed execution plan to enable Application
																	Transformation. Getting there will require
											...
											<div>
												...
												<div>
													...
													<p className='ptext'>
														...
														assemble various functionalities and truly become an API driven
														organization with an API centric application architecture. This
														allows the organization to become a low-code organization where
														they 'assemble apps' rather than write apps.
													</p>
													<p className='ptext'>
														{' '}
														<span className='fw'>Data Lake:</span> Extracting the data in a
														Data Lake and exposing that data through analytical tools.
													</p>
													<img
														src={ms10}
												...
												<div>
													...
													<p className='ptext'>
														...
														can leverage, to build applications and services rapidly with
												...
												<div>
													...
													Synectiks application development service offering allows customers
													to realize the real benefit of using cloud-native services and
													boosting innovation agility. The offering involves application
													redevelopment to implement use cases for batch processing, workflow
													processing, transient server less functionality or container based
													microservices. Synectiks open Xformation platform offers App/
													Delivery/ Automation blocks based on cloud-native services that
													customers can leverage to build application and services rapidly. A
													typical microservice based enterprise application component diagram
													is below:
													<img
														src={eptr}
												...
												<div>
													...
													<p className='ptext'>
														Synectiks analytic service offering allows customers to create
														...
														simplifies the operations complexity by running the multistage
														transactional services, batch workloads and streaming analytics
														inside a single platform. With Synectiks' deep expertise on
														hardware aggregations coupled with its analytics services
														offerings, customers can seamlessly run every mission critical
														workloads inside a single cluster platform and can truly focus
														on outcomes.
													</p>
										...
										<TabPane tabId='4'>
											<div>
												<p className='ptext'>
													...
													it, run it and manage it.<br /> Synectiks reduce the application
													transformation effort at least by 50% by using open Application
													blocks (common services for any product), automation blocks and
													component frameworks built by SYNECTIKS team, so that you can
													leverage lot of existing code and reuse your existing codebase. A
													typical large transformation project can take a year-long effort and
													often don’t yield results. We recommend taking bottom - up approach,
													take a small piece of functionality, and develop the services and
													foundation for it rapidly by using existing application blocks and
													automation framework. You would minimize your risks by investing a
													small time & money and continue to do so when you see a significant
													ROI. The key aspect is time. The advantage of making us your
