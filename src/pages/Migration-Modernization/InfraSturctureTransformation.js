                  ...
                  <TabPane tabId="1">
                    <div>
                      ...
                      <p className="ptext">
                        ...
                        operates independent of hardware-specific dependencies
                      ...
                      <div>
                        <p className="ptext">
                          ...
                          maintain a competitive edge in a highly dynamic
                          market, businesses need to re-imagine the customer
                          experience in lower economies. The challenge is that
                          today’s competitive environment is accelerating faster
                          than the most convenient infrastructure can support.
                          Businesses need an entirely new, cloud-native approach
                          – that is primed for innovation and agility from the
                          ground up. The emergence of cloud and virtualization,
                          combined with dramatic cost reductions for data center
                          hardware, has driven an evolution to a large
                          homogeneous, Hybrid IT which is comparatively easy and
                          cost effective to manage. Enterprises are looking for
                          an exponential reduction in the provisioning cycle for
                          compute / storage / network while delivering the
                          scalability, stability, speed and efficiency required
                          to support rapidly evolving businesses.
                          Software-defined infrastructure (SDI) mainly drives
                          this change. Infrastructure transformation is the
                          first technology waypoint on the cloud-native
                          approach. Businesses need to lay the foundation for
                          innovation by forensically re-architecting the
                          existing legacy environment in support of business
                          objectives such as controlling costs, supporting
                          growth, driving efficiency and more.
                        </p>
                        <p className="ptext">
                          ...
                          ownership, improve service velocity, and accelerate
                    ...
                    <div>
                      <div>
                        ...
                        <p className="ptext">
                          ...
                          enterprise. By following the blueprint and Powerful
                        ...
                        <div className="d-flex flex-column flex-md-row align-items-center">
                          ...
                          <div>
                            <p className="ptexticon">
                              ...
                              people / process / technologies along with
                        ...
                        <div className="row">
                          ...
                          <div className="col-sm-4 col-md-4 text-center d-flex align-items-center flex-column">
                            ...
                            <p className="text-left">
                              ...
                              well-defined blueprints and pipelines that adhere
                              to highest level of security & compliance.
                            </p>
                          </div>
                          <div className="col-sm-4 col-md-4 text-center d-flex align-items-center flex-column">
                            <div className="d-flex align-items-center flex-column">
