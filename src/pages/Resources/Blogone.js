					...
					<div className='textWrapper w75'>
						...
						<div>
							<p>
								...
								Everybody prefers to address the complexity in a code base, at the cost of solving
								complexity in interaction. My views on the most important five questions that need to be
								answered when implementing large scale #transformation are:
							</p>
							<h5 className='ft'>1) Management Complexity of Container Clusters Across Clouds & Locations</h5>
							<p>
							...
							<h5 className='ft'>2) CapEx Involved in Management Control Plane</h5>
							<p>
								How do you reduce your CapEx for many a control plane for many a container cluster. When
								you trigger the transformation, you will spawn another network of container clusters
							...
							<h5 className='ft'>3)Manage Container Clusters in Hybrid IT</h5>
							<p>
