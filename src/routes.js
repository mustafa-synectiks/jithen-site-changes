...
module.exports = [
  ...
  },
  {
    ...
    component: path.resolve(
      `src/pages/Migration-Modernization/DevopsTransformation.js`
    )
  },
  {
    // 3WL
  ...
  },
  {
    ...
    component: path.resolve(
      `src/pages/Migration-Modernization/InfraSturctureTransformation.js`
    )
  },
  {
    // 15WL
    ...
    component: path.resolve(
      `src/pages/Migration-Modernization/ApplicationTransformation.js`
    )
  },
  {
    // 16WL
